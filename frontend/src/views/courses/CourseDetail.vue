...
<template>
    <div v-if="course" class="space-y-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <Card>
                <CardHeader class="pb-2">
                    <div class="flex items-center justify-between">
                        ...
                        <Button size="sm" class="cursor-pointer" @click="selectedSubject = null; openSubjectModal = true">
                ...
                <CardContent>
                    ...
                    <div v-for="subject in subjects" :key="subject.id"
                        ...
                        <div>
                            ...
                            <p class="text-sm text-muted-foreground">{{ subject.description }} · Weight: {{ subject.weight }}</p>
                        </div>
                        <div class="flex gap-2">
                            <Button variant="ghost" size="icon" @click="selectedSubject = subject; openSubjectModal = true">
            ...
            <Card>
                ...
                <CardContent>
                    <div v-if="enrollments.length === 0" class="text-muted-foreground text-sm">No students enrolled.</div>
                    <div v-for="enrollment in enrollments" :key="enrollment.id"
                        class="flex items-center justify-between py-2 border-b last:border-0">
                        <div>
                            <p class="font-medium">{{ enrollment.student.first_name }} {{ enrollment.student.last_name }}</p>
    ...
    <SubjectModal
        ...
        @update:open="openSubjectModal = $event"
        @saved="refreshCourse" 
    />
    ...
    <EnrollStudentModal
        ...
        @update:open="openEnrollModal = $event"
        @enrolled="refreshEnrollments" />
